...
class WebSocketManager:
    ...
    async def connect(self, websocket: WebSocket, client_id: str = None):
        ...
        try:
            ...
            logger.info(f"New WebSocket connection established for client {client_id}. Total connections: {len(self.active_connections)}")
    ...
    def disconnect(self, websocket: WebSocket, client_id: str = None, reason: str = None):
        ...
        disconnect_msg = f"WebSocket connection closed for client {client_id or 'unknown'}"
        if reason:
