...
class WidgetConfig(BaseModel):
    ...
    rotation: float = Field(0, ge=-360, le=360, description="Widget rotation in degrees")
    ...
    # Animation settings
    animation_settings: Dict[str, Any] = Field(default_factory=dict, description="Animation configuration")
...
class WidgetGroup(BaseModel):
    ...
    # Group contents
    widget_ids: List[str] = Field(default_factory=list, description="List of widget IDs in group")
...
class VisualSettings(BaseModel):
    ...
    information_density: float = Field(0.5, ge=0, le=1, description="Information density")
    ...
    # Typography
    font_family: str = Field("Inter, system-ui, sans-serif", description="Primary font family")
...
class DashboardPreset(BaseModel):
    ...
    visual_settings: VisualSettings = Field(default_factory=VisualSettings, description="Visual settings")
