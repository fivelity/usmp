...
// Derived state
export const getIsDarkMode = () => visualSettings.theme === "dark";
export const getIsHighContrast = () => visualSettings.highContrast;
export const getHasAnimations = () =>
  visualSettings.enable_animations && !visualSettings.reduce_motion;
...
export const computedVisualSettings = derived(
  [visualSettingsOriginal],
  ([$visualSettings]) => ({
    ...$visualSettings,
