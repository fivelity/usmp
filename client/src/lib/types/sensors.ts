...
export type ConnectionStatus = "connected" | "disconnected" | "connecting" | "error" | "initializing"
...
export type AlertType = "threshold_high" | "threshold_low" | "rate_change" | "sensor_offline" | "data_quality"
...
export type AggregationLevel = "raw" | "minute" | "hour" | "day" | "week" | "month"
...
export interface WebSocketSensorMessage {
  type: "sensor_data" | "sensor_update" | "hardware_change" | "connection_status" | "error" | "heartbeat"
  timestamp: string
  source_id: string
  data?: any
  error?: string
