...
import type { SystemMetric } from './widgets';
...
export interface WidgetConfig {
  ...
  gauge_settings?: SystemStatusConfig; // Added for SystemStatusInspector
  style?: WidgetStyle
  metadata?: Record<string, unknown>
}
...
export interface SystemStatusConfig extends GaugeSettings {
  ...
  // Add any SystemStatusConfig-specific properties here in the future
}
...
export interface WidgetEvent {
  type: 'select' | 'deselect' | 'move' | 'resize' | 'lock' | 'unlock' | 'delete' | 'duplicate'
  widget_id: string
  data?: unknown
  timestamp: string
  metadata?: Record<string, unknown>
