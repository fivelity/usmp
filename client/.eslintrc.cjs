module.exports = {
  ...
  settings: {
    ...
    "svelte3/ignore-warnings": (warning) => {
      ...
      if (warning.code === "svelte-require-store-callbacks-use-set-param")
        return true;
      ...
      if (warning.code === "typescript-eslint/no-non-null-assertion")
        return true;
      ...
      if (warning.code === "typescript-eslint/no-extra-boolean-cast")
        return true;
      if (warning.code === "typescript-eslint/no-extra-non-null-assertion")
        return true;
      return false;
    },
  },
